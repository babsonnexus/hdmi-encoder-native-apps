...
* **A&E Global Media - History Family**
  * History
  * UnXplained Zone
  * Deal Zone
  * Ax Men
...
* **A&E Global Media - FYI Family**
  * FYI
 
* **A&E Global Media - Lifetime Family**
  * Lifetime
  * Lifetime Movies Love & Drama
  * Lifetime Movies Favorites
  * Dance Moms
...
4. **Set up Android TV Streaming Dongles**
    ...
    After that, you will need to install all or a subset of the following native apps, contingent on which of the stations listed before you want:
    ...
    * AMC
    ...
    Depending upon your device, not all apps may be readily available. For instance, the [AMC app](https://www.apkmirror.com/apk/amc-networks/amc-fire-tv/) is missing from some devices like the TiVO Stream 4K+. In these situations, you can download the APK and sideload the app. It is highly recommended to use **[adblink](https://www.jocala.com)** for this activity. And to reiterate, if you don't want specific station groups, you do not need to install that app associated with them. You can just choose to either not install those stations, remove them after the fact, or disable/ignore them.
...
3. **OPTIONAL:** Modify the station numbers
    ...
    The default station numbers are organized by providers, not purpose or any other logic. If you would like to change them, you are more than free to do so. Just know that within ADBTuner, that can modify the display order, although you can also use the `Sort Order` (which is the same as the station numbers here). There are other tools that can change the station numbers for you, too, as highlighted below.
...
5. **REQUIRED:** Test every station
    ...
    That said. some apps have included an "alternative" app to try for just such a situation, so this action may not be necessary for you:
